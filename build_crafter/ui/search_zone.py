...
from ui.item_list_display import ItemListDisplay # Assurez-vous que l'import est correct
...
class SearchZone(tk.Frame):
    ...
    def __init__(self, parent, placeholder="Rechercher...", bg_color="lightgrey",
                 items_to_display=None, on_item_select_callback=None, # <<< Ajouté
                 *args, **kwargs):
